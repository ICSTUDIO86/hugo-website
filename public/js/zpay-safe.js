...
(function() {
  ...
  window.createZPayment = function() {
    ...
    try {
      ...
      // 使用Base64编码的参数名 - "notify_url" 的Base64是 "bm90aWZ5X3VybA=="
      const encodedKey = atobSafe('bm90aWZ5X3VybA==');
      paramMap.set(encodedKey, 'https://icstudio.club/api/cb');
      ...
      console.log('Safe Params:', params);
      
      // 验证notify_url是否正确设置
      console.log('Notify URL check:', params['notify_url'] || params[encodedKey]);
  ...
  console.log('Z-Pay Safe Version loaded');
})();