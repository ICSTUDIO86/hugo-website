...
const I18n = {
    ...
    translations: {
        ...
        'en': {
            ...
            'controls.chordSymbols': 'Chords',
            'controls.jianpuChordSymbols': 'Jianpu',
            'controls.chordSymbolsShow': 'Show Chords',
            'controls.chordSymbolsHide': 'Hide Chords',
            ...
            'controls.randomMode': 'Pure Random',
            'controls.pureRandomMode': 'Pure Random',
            'controls.functionalMode': 'Functional Harmony',
            'controls.functionalModeFull': 'Functional Harmony',
            'controls.pureRandomModeFull': 'Pure Random Mode',
            'controls.guitarMode': 'Guitar Harmony',
            'controls.guitarModeFull': 'Guitar Harmony',
            'controls.pianoMode': 'Piano Harmony',
            'controls.pianoModeFull': 'Piano Harmony',
