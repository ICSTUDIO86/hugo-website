...
(function() {
  ...
  const I18N = {
    zh: {
      ...
      lookupInputPlaceholder: '例如 IFL17xxxxxxxxxxxxxxx、IBD17xxxxxxxxxxxxxxx 或 20-32位数字支付订单号',
      usageTitle: '📋 使用说明',
      merchantOrderTip: '• 商家订单号：支付后生成，例如 IFL17xxxxxxxxxxxxxxx 或 IBD17xxxxxxxxxxxxxxx',
    ...
    en: {
      ...
      lookupInputPlaceholder: 'e.g. IFL17xxxxxxxxxxxxxxx, IBD17xxxxxxxxxxxxxxx, or a 20-32 digit payment order number',
      usageTitle: '📋 Notes',
      merchantOrderTip: '• Merchant order number: generated after payment, e.g. IFL17xxxxxxxxxxxxxxx or IBD17xxxxxxxxxxxxxxx',
  ...
  function renderBundleDownloadSectionHtml() {
    return ''
      ...
      + '</div>'
      + '<div data-fretlab-download-panel="fretlab" style="display:grid;grid-template-columns:1fr;gap:8px;margin-top:12px;">' + renderDownloadButtonsHtml('fretlab') + '</div>'
      + '<div data-fretlab-download-panel="cognote" style="display:none;grid-template-columns:1fr;gap:8px;margin-top:12px;">' + renderDownloadButtonsHtml('cognote') + '</div>';
  }
